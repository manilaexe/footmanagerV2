...
async function inviaRispostaQuiz(rispostaScelta) {
    ...
    try {
        ...
        if (esito.corretta) {
            ...
            // Se sono stati sbloccati nuovi badge, mostrali subito nella mini-lista
            // del profilo. L'elenco completo (sbloccati/da sbloccare) si trova
            // nella pagina dedicata "I miei badge" (badge.html).
...
// ─── 10. GAMIFICATION: BADGE (notifica veloce dal quiz) ───────────────────
/*
 * Il quiz del giorno resta qui in dashboard e continua a funzionare come
 * prima: quando una risposta corretta fa scattare l'assegnazione di un
 * nuovo badge (QuizService.verificaBadge lato backend), lo mostriamo subito
 * nella mini-lista accanto ai punti, nella card profilo in alto.
 * L'elenco completo di tutti i badge (sbloccati e da sbloccare, con soglie
 * e date) vive nella pagina dedicata "I miei badge" → /html/badge.html
 * (gestita da badge.js), raggiungibile dalla sidebar.
 */
